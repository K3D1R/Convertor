    ...
    if name == 'вспв':
        ...
        if sheet_name in sheet_list:
            ...
            if len(sheet_name) >= 30:
                sheet_name = input('Имя выбранного листа слишком большое. Введите имя которое будет присвоено листу в шаблоне МЧ')
                ...
                for row in range(3, end_num):
                    ...
                    if status:
                        if status.lower() in statuses_pl:
                            ...
                            elif status.lower() == 'организатор':
                                wsh21[cell] = statuses[4]
                            else:
                                status = status + ' '
            ...
            print('Не существует такого листа')